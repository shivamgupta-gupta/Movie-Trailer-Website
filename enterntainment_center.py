...
""" Here, toy_story, avatar, school_of_rock etc. are the instances of
class Movie."""

""" To call the constructor(__init__()) of class Movie, first we have
to import media file and then we can call constructor using
media.Movie(). """
...
""" To generate an html page of the Movie Trailer website, we have to
call open_movies_page() function which takes the movie instances
as arguments in the form of list """
